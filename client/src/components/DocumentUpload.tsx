          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <section className="bg-muted/10 p-6 rounded-xl border">
              ...
              <p className="text-muted-foreground text-sm">
                {user?.role === "student" ? (
                  <>
                    For scholarship or reservation claims, please contact admissions office after
                    submitting initial documents.
                  </>
                ) : (
                  <>
                    For specialized roles, you may upload portfolio/research papers after initial
                    verification.
                  </>
                )}
              </p>
